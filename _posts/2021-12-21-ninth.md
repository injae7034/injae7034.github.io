...
대신에 저는 간단하 예시보다는 **상대적으로 조금 더 복잡한 프로그램을 구현하면서 이를 설명**하려고 합니다.<br><br>
이러한 과정 속에서 간단한 프로그램을 구현할 때 알고 있는 개념이 어떻게 적용되는지 이해하시는데 도움이 되리라 믿습니다.<br><br>
...
# 마치며
저 스스로도 프로젝트를 직접 구현하면서 배웠던 개념을 적용해보니 이해하는 것이 더많아서 기록으로도 남길겸해서 그 과정을 블로그로 작성했습니다.<br><br>
그래서 틀린 내용이나 미흡한 내용이 있을 수 있습니다.<br><br>
