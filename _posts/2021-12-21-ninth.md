---
layout: single
title:  "Java로 주소록 구현하기 - String의 특성으로 인한 복사"
categories: Java
tag: [Java, 주소록, 프로젝트, AddressBook, 얕은 복사, 깊은 복사, String의 특성, clone]
toc: true
toc_label: "목차"
toc_sticky: true
---
...
그래도 상관없는 이유는 **자바에서 String은 객체의 문자열 값을 변경하면 새로운 객체를 생성**하기 때문입니다.
### String의 특성
